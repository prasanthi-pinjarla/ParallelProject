...
public class Client {
	...
	public void showbalance() throws CustomerException, Exception {
		...
		System.out.println("\t Name of the customer\t\t: " + accountBean.getCustomerBean().getFirstName() + " "
	...
	public void withdraw() throws Exception {
		...
		if (accountBean == null) {
			...
			System.out.print("\t Your current balance is\t\t: "+accountBean.getBalance());
	...
	public void fundtransfer() throws Exception {
		...
		if (accountBean1 == null) {
			...
			if (accountBean2 == null ) {
				...
				accountBean2.addTransaction(wt1);*/
	...
	public void printTransaction() throws Exception {
		...
		System.out.println("\t Customer Details [ " + accountBean.getCustomerBean().getFirstName() + " "
				+ accountBean.getCustomerBean().getLastName() + " , " + accountBean.getCustomerBean().getEmailId()
